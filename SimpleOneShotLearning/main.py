...
fname_label = 'class_labels.txt' #where class label are stored for each run
path_to_all_runs = 'all_runs'
...
if __name__ == "__main__":
    ...
    perror = np.zeros(nrun) #used to store classification error rates
